...
static struct cmdtab mged_cmdtab[] = {
    ...
    {"nmg_me", cmd_ged_plain_wrapper, ged_nmg_me},
    {"nmg_meonvu", cmd_ged_plain_wrapper, ged_nmg_meonvu},
    ...
    {"nmg_mvu", cmd_ged_plain_wrapper, ged_nmg_mvu},
    {"nmg_mvvu", cmd_ged_plain_wrapper, ged_nmg_mvvu},
