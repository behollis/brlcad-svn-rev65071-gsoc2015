...
{
	/* Make Shell, Vertex. Creates a new shell consisting of a single vertex in
	 * the parameter region. A new vertex is created for the shell.
	 */
	...
	/* for now, let's just added shell and vertex for the first
	 * encountered region in model.
	 * TODO: take region from CLI */
